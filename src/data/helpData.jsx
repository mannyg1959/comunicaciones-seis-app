...
export const helpData = {
  dashboard: (
    <div>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Tarjetas KPI</h4>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Pestañas de Análisis</h4>
  ...
  cotizaciones: (
    <div>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Estatus de Cotizaciones</h4>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Generar PDF</h4>
  ...
  ordenesTrabajo: (
    <div>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Etapas (Kanban)</h4>
      <ul style={{ paddingLeft: '1.2rem', margin: 0 }}>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Incidencias y Pausas</h4>
  ...
  herramientas: (
    <div>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Reportes</h4>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Exportar CSV</h4>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Monitor Ticker</h4>
  ...
  ajustes: (
    <div>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Gestión de Usuarios</h4>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Roles y Permisos</h4>
      ...
      <h4 style={{ color: '#fff', marginTop: '1.5rem', marginBottom: '0.5rem' }}>Log de Auditoría</h4>
